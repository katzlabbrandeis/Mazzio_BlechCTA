...
# Load data
# ==============================================================================
# give directory to folder containing individual segments files produced 
    # by Blech_EMG_Classifier
...
# Give path to folder containing all corresponding .info files from BlechClust
